...
function changeBackGround(cxt,e){
	   // 绘制电量状态栏
       var bar = new Image()
       bar.src = 'img/bar.png'
       bar.onload = function() {
       cxt.drawImage(bar, 5, 0)	   
        ...
        var s=e.toString()
        cxt.beginPath()
        cxt.fillStyle="rgb(42,40,44)"
        cxt.fillRect(309,3,19,10)
        cxt.fillStyle="rgb(148,147,149)"
        cxt.fillRect(345+e*0.2,3,0.2*(100-e),7)
        cxt.font = 'lighter 14px Heiti SC'
        cxt.fillStyle = '#ffffff'
        cxt.fillText(s,315,0)
       
        // 绘制左上角的“微信”
       cxt.beginPath()
       cxt.fillStyle="rgb(54,53,55)"
       cxt.fillRect(24,32,31,16)
